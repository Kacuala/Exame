    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php">Melhor<pan>Vinho</span></a></h1>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    echo number_format($final,2,',','.'); 
                        ...
                        ?>kz</span> <i class=" shopping-cart"></i> <span class="product-count"><?php    if (isset($conta)) {
                            # code...
                            echo $conta ;
                        }?> </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name"><?php if(isset($produto)){ echo "$produto";} ?></h2>
                                    <div class="product-inner-price">
                                        <ins><?php if(isset($produto)){ echo number_format($preco,'2',',','.');} ?>kz</ins> <del>$800.00</del>
                                    </div>    
                                    
                                    <?php if(isset($idp)){ echo"<form action='?acao=add&id=".$idp."' class='cart' method='POST'>";} ?>
                                        <div class="quantity">
